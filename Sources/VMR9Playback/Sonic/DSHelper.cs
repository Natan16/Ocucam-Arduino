...
namespace Sonic
{
        ...
        public List<AMMediaType> MediaTypes
        {
            get 
            {
                ...
                if (this)
                {
                    ...
                    if (SUCCEEDED(m_pUnknown.EnumMediaTypes(out pEnum)))
                    {
    ...
    public class DSFilter : DSObject<IBaseFilter>
    {
        ...
        public string Name
        {
            get 
            {
                if (this)
                {
                    FilterInfo _info = new FilterInfo();
                ...
                if (this)
                {
                    if (value == null)
                    {
                        ...
                        if (SUCCEEDED(m_pUnknown.QueryFilterInfo(_info)))
                        {
                            if (_info.pUnk != null)
                            {
                                IGraphBuilder _graph = (IGraphBuilder)_info.pUnk;
        ...
        public HRESULT ShowProperties(IntPtr _hwnd)
        {
            try
            {
                ISpecifyPropertyPages pProp = (ISpecifyPropertyPages)QueryInterface(typeof(ISpecifyPropertyPages));
                if (pProp != null)
                {
                    DsCAUUID pCAUUID;
                    pProp.GetPages(out pCAUUID);
                    object oDevice = (object)m_pUnknown;
    ...
    public class DSLegacyAmFilterCategory : DSCategory
    {
        #region Constructor

        public DSLegacyAmFilterCategory()
            : base(FilterCategory.LegacyAmFilterCategory)
        {
    ...
    public class DSDMOFilterCategory : DSCategory
    {
        #region Constructor

        public DSDMOFilterCategory()
            : base(FilterCategory.DMOFilterCategory)
        {
